...
use crate::{BlockId, TileIrFunction, TileIrOp, TileIrTerminator, ValueId};

pub fn verify_function(func: &TileIrFunction) -> Result<(), String> {
...
#[allow(dead_code)]
fn _is_side_effecting(op: &TileIrOp) -> bool {
    matches!(
        op,
