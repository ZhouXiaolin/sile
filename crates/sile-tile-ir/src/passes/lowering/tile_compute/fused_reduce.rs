...
use crate::passes::lowering::core::{
    BlockLowerer, alloc_tile_result, buffer_rank_of, const_i64, emit_gep, emit_load,
    emit_store, lower_nested_tile_loop, resolve_operand,
};
...
pub(crate) fn lower_fused_load_reduce_inst(
    ...
    lower_nested_tile_loop(
        ...
        move |ctx, _, out, row, col| {
            // Initialize accumulator from first element
