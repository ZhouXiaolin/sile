...
pub(crate) struct LowerLlvmIrCtx {
    ...
    pub(crate) buffer_shape_descs: HashMap<llvm_ir::ValueId, llvm_ir::ValueId>,
    pub(crate) shape_dim_cache: HashMap<(llvm_ir::ValueId, usize), llvm_ir::Operand>,
...
impl LowerLlvmIrCtx {
    pub(crate) fn new(tile_ir: &TileIrFunction) -> Self {
        Self {
            ...
            buffer_shape_descs: HashMap::new(),
            shape_dim_cache: HashMap::new(),
            shapes_param: None,
            prologue_entry: None,
