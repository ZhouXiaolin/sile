...
fn softmax_typeck_infers_reduce_and_broadcast_shapes() {
    ...
    assert_eq!(typed.locals["tile_x"].category(), sile::hir::ValueCategory::Tile);
    assert_eq!(typed.locals["tile_x_max"].category(), sile::hir::ValueCategory::Tile);
    assert_eq!(typed.locals["denom"].category(), sile::hir::ValueCategory::Tile);
}
