...
#[test]
fn dynamic_k_matmul_llir_codegen_emits_structured_metal_from_llvm_like_ir() {
...
#[test]
fn vec_add_llir_codegen_emits_structured_metal_from_llvm_like_ir() {
...
#[test]
fn softmax_llir_codegen_lowers_reduce_and_broadcast_into_llvm_like_metal() {
